...
mean_compare_plot
# THuy: This plot is great. I would just suggest to add color to show direction of differences (subtracting one from the other and show whether that diff is negative or positive. Just like we did in homework 1)
```
...
corplot
#Thuy: the corplot is nice! I like the idea that you use color divergence here. Just a minor note that later you may not want to the numbers in there :)
